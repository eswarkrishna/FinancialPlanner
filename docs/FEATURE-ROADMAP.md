...
1. **Competitor gap-fill** ([`research/2026-07-gap-fill-competitors.md`](research/2026-07-gap-fill-competitors.md)) — prepay fee + EMI/tenure compare **shipped**; floating rates + bank validation **shipped**; **PPF**, **SIP**, and **SSY** shipped (§4.17–§4.19); next: lakh/crore formatting, gratuity
...
- [ ] Remaining: gratuity, lumpsum, drawdown phase, budget charts, tax-aware rate, SEO polish
