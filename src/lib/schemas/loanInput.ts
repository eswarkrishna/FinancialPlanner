...
export const loanInputSchema = z.object({
  ...
  /** Keep-EMI basis: formula EMI vs contractual current EMI (§4.4.3). */
  emi_basis: z.enum(["baseline", "current"]).optional().default("baseline"),
  current_emi_inr: z.coerce.number().min(0).optional().default(0),
